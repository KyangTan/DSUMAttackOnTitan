...
//    }
//    
//    public void switchToNavBar(MouseEvent event) throws IOException {
//        FXMLLoader loader = new FXMLLoader();
//        loader.setLocation(getClass().getResource("navBar.fxml"));
//        loader.load();
//        navBarController nbc = loader.getController();
//        switchScene(event, "navBar.fxml");
//    }
//
//    public void switchToCharacterScene(MouseEvent event) throws IOException {
//        switchScene(event, "characterPage.fxml");
//    }
//
//    public void switchToSearchScene(MouseEvent event) throws IOException {
//        switchScene(event, "searchPage.fxml");
//    }
//
//    public void switchToKillTitansScene(MouseEvent event) throws IOException {
//        switchScene(event, "killTitansPage.fxml");
//    }
//
//    public void switchToScoutingScene(MouseEvent event) throws IOException {
//        switchScene(event, "scoutingPage.fxml");
//    }
//
//    public void switchToDecipherScene(MouseEvent event) throws IOException {
//        switchScene(event, "decipherPage.fxml");
//    }
//
//    public void switchToWallScene(MouseEvent event) throws IOException {
//        switchScene(event, "mariaWallPage.fxml");
//    }
//
